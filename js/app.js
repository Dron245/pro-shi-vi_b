            ...
            if (spaceHolder) {
                spaceHolder.forEach((element => {
                    ...
                    window.addEventListener("scroll", (() => {
                        ...
                        element.style.height = `${calcDynamicHeight(horizontal)}px`;
                        if (window.activeScroll) window.activeScroll();
                    }));
                ...
                function calcDynamicHeight(ref) {
                    ...
                    if (document.body.clientWidth > 1920) return objectWidth - vw + vh + vw / 3;
                    if (document.body.clientWidth > 1366) return objectWidth - vw + vh + vw / 3;
                    if (document.body.clientWidth <= 1366) return objectWidth - vw + vh + vw / 3;
                }
            }
        }
